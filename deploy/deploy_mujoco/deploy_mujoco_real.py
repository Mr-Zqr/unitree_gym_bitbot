        ...
        while viewer.is_running() and time.time() - start < simulation_duration:
            ...
            if counter % control_decimation == 0:
                ...
                if show_log and (counter*simulation_dt) < show_log_time: 
                    ...
                    logger.plot_states("deploy_mujoco", 0, robot_name, dof_pos_limits, robot_name, action_scale)
                    if save_csv:
                        logger.save_csv("deploy_mujoco", 0, robot_name, dof_pos_limits, robot_name, action_scale)
