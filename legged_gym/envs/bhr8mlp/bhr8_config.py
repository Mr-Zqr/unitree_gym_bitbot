...
# used for training
class BHR8MLPRoughCfg( LeggedRobotCfg ):
    ...
    class env(LeggedRobotCfg.env):
        ...
        a_obs_unit = 47
        a_prev_obs_unit = 50
        num_observations = a_obs_unit * a_stack_length
        num_privileged_obs = a_prev_obs_unit 
        num_actions = 12
...
class BHR8MLPRoughCfgPPO( LeggedRobotCfgPPO ):
    class policy:
        init_noise_std = 0.8
